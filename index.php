        ...
        <table class="table table-hover">
            ...
            foreach ($_SESSION['cart_item'] as $key_car => $val_cart_item): ?>
                <tr>
                    ...
                    <td><img class="card-img-top" style="height: 25px; width: auto; display: block;"
                             src="images/<?php echo $val_cart_item['product_image'] ?>" data-holder-rendered="true">
                    </td>
                    <td><?php echo $val_cart_item['price'] ?></td>
                    <td><?php echo $val_cart_item['quantity'] ?></td>
                    <td><?php $total_item = $val_cart_item['price'] * $val_cart_item['quantity'];
                        echo number_format($total_item,0,",", ".")
                        ?> VNĐ</td>
                    <td>
                        <form action="process.php" name="remove <?php$val_cart_item['id'] ?>" method="post">
                            <input type="submit" name="submit" class="btn btn-sm btn-outline-secondary" value="Xóa giỏ hàng">
                            <input type="hidden" name="product_id" value="<?php$val_cart_item['id'] ?>">
                        ...
                        <div class="card mb-4 box-shadow">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <!--form-inline hiện thị trên một dòng code-->
