...
if(isset($_POST)&& (!empty($_POST))){
    /**
     * Kieểm tra dữ liệu được gửi đi và có dữ liệu được gửi đi;
     */
            ...
            case 'add':
                if(isset($_POST['quantity']) && isset($_POST['product_id'])){
                    ...
                    if(isset($_SESSION['cart_item']) && !empty($_SESSION['cart_item'])){
                        // True:: Có dữ liệu Giỏ hàng có dữ liệu
                        // Giỏ hàng không có dữ liệu

                        if(isset($_SESSION['cart_item'][$product_id])){
                            //Nếu sản phẩm tồn tại thì cập nhật số liệu
...
header("Location: http://localhost:8080/simple_shop/index.php");
die();